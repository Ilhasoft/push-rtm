...
class Poll(SmartModel):
    ...
    def delete_poll_stats(self):
        from rtm.utils import chunk_list
        from rtm.stats.models import PollStats
    ...
    def pull_refresh_task(self):
        from rtm.utils import datetime_to_json_date
    ...
    def rebuild_poll_results_counts(self):
        from rtm.utils import chunk_list
        from rtm.stats.models import PollStats, AgeSegment, GenderSegment
    ...
    def calculate_results(self, segment=None):
        ...
        if open_ended and not segment:
            ...
            with connection.cursor() as cursor:
                ...
                from rtm.utils import get_dict_from_cursor
