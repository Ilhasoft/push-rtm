# Generated by Django 2.2.5 on 2019-10-18 19:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The name for flow', max_length=128, verbose_name='Name')),
                ('description', models.TextField(verbose_name='Description')),
                ('collected_data', models.TextField(help_text='What data does this data collect from contacts?', verbose_name='Collected Data')),
                ...
                ('visible_globally', models.BooleanField(default=False, verbose_name='Visible Globally')),
                ...
                ('created_by', models.ForeignKey(help_text='The user which originally created this item', on_delete=django.db.models.deletion.PROTECT, related_name='flowhub_flow_creations', to=settings.AUTH_USER_MODEL)),
                ('modified_by', models.ForeignKey(help_text='The user which last modified this item', on_delete=django.db.models.deletion.PROTECT, related_name='flowhub_flow_modifications', to=settings.AUTH_USER_MODEL)),
                ('org', models.ForeignKey(help_text='The organization this flow is part of', on_delete=django.db.models.deletion.CASCADE, related_name='flows', to='orgs.Org', verbose_name='UNCT')),
                ('stars', models.ManyToManyField(to=settings.AUTH_USER_MODEL, verbose_name='Stars')),
