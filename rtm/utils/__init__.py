...
def fetch_flows(org, backend=None):
    from rtm.polls.models import CACHE_ORG_FLOWS_KEY, UREPORT_ASYNC_FETCHED_DATA_CACHE_TIME
...
def fetch_old_sites_count():
    import requests
    import re
    from rtm.polls.models import UREPORT_ASYNC_FETCHED_DATA_CACHE_TIME
...
def get_org_contacts_counts(org):
    ...
    from rtm.contacts.models import ReportersCounter
